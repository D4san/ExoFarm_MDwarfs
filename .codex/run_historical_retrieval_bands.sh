...
exec /home/dasan/anaconda3/envs/POSEIDON/bin/python plot_retrieved_zooms.py \
  > /mnt/c/Proyectos/Astro/ExoFarm_MDwarfs/.codex/historical_retrieval_bands.log 2>&1
