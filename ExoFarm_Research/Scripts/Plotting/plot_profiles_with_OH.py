...
# --- Plot 2: Trends (Scatter - 5 Subplots) ---
# 5 molecules -> 2 rows x 3 columns layout
fig2, axes2 = plt.subplots(2, 3, figsize=(18, 10), sharex=True)
axes2 = axes2.flatten()
fig2.suptitle("Abundance Trends (including OH): Agriculture Intensity vs Star Type", fontsize=18, y=0.98)
